...
class WeeklySpendingChart extends StatelessWidget {
  ...
  const WeeklySpendingChart({super.key, required this.transactions});
                              ...
                              barRods: [
                                BarChartRodData(
                                  ...
                                  backDrawRodData: BackgroundBarChartRodData(
                                    show: true,
                                    toY: weekData.values.fold<double>(0, (prev, v) => v > prev ? v : prev),
      ...
      child: Padding(
        ...
        child: Text(
          ...
          style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600),
              ...
              Text('Tap a bar for details', style: TextStyle(fontSize: 12, color: Colors.indigo.shade300)),
            ],
          ),
        ),
      ),
